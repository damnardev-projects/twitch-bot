...
import fr.damnardev.twitch.bot.server.database.entity.DbSuggestGame;
...
@DataJpaTest
@Sql("/fr/damnardev/twitch/bot/server/database/repository/db_suggest_game_repository_tests.sql")
