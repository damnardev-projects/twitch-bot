...
import fr.damnardev.twitch.bot.server.database.entity.DbCredential;
...
@DataJpaTest
@Sql("/fr/damnardev/twitch/bot/server/database/repository/db_credential_repository_tests.sql")
